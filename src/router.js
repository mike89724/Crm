...

    {
      ...
      children: [
        ...
        },
        {
          path: '/loan/overview',
          name: 'dashboardLoans',
          component: () => import('./views/DashboardLoans.vue'),
          meta: {
            rule: 'editor'
          }
        },
        {
          ...
          name: 'dashboardReserves',
          component: () => import('./views/DashboardReserves.vue'),
          meta: {
            rule: 'editor'
          }
        },
        {
          path: '/search/:query',
          name: 'query',
          component: () => import('./views/TxSearchPage.vue'),
          meta: {
            rule: 'editor'
          }
        },
        ...
        {
          path: '/graph/reserve_utilization',
          name: 'reserve_utilization',
          component: () => import('./views/StackedBarGraphFullView.vue'),
          meta: {
            rule: 'editor'
          }
        },
        ...
        },
        {
          path: '/tokenPrice',
          name: 'tokenPrice',
          component: () => import('./views/TokenPriceTicker.vue'),
          meta: {
            rule: 'editor'
          }
        },
        {
          path: '/trade/orders',
          name: 'tradefull',
          component: () => import('./views/ui-elements/table/TableTradeDetailsFull.vue'),
          meta: {
            rule: 'editor'
          }
        },
        ...
        },
        {
          path: '/reserve/orders',
          name: 'reservefull',
          component: () => import('./views/ui-elements/table/TableReserveDetailsFull.vue'),
          meta: {
            rule: 'editor'
          }
        },
        {
          path: '/transactions',
          name: 'transactions',
          component: () => import('./views/ui-elements/table/RecentTransactions.vue'),
          meta: {
            rule: 'editor'
          }
        },
